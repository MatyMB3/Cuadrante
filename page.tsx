  ...
  async function respond(status: "going" | "not_going" | "waitlist") {
    ...
    if (!pid) {
      ...
      const { data, error } = await supabase
        ...
        .single();
      if (error || !data) {
        alert("No pudimos guardar tu respuesta. Probá de nuevo.");
        return;
      }
      pid = data.id;
    ...
    <>
      ...
      <div className="px-6 pt-6">
        ...
        <div className="mt-7 space-y-4 pb-10">
          <ParticipantGroup label="🟢 Van" list={going} />
          <ParticipantGroup label="🟡 Pendientes" list={pending} muted />
          <ParticipantGroup label="🔴 No van" list={notGoing} muted />
